...
<body id="page-top">
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="<%=request.getContextPath()%>/assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
	...
	<section class="page-section portfolio" id="portfolio"></section><div>
                                     ...
                                     <table align="center">
                                         ...
                                         <tr>
                                             <td>
                                               <a href="<%=request.getContextPath()%>/Patient/Credit/insertCard.jsp"  ><img style="width: 400px; height: 260px;" src="<%=request.getContextPath()%>/Images/card.avif" alt="Add Credit"/></a>
                                             </td>
